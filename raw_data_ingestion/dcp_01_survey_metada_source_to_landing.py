...
# MAGIC %md
# MAGIC
# MAGIC ## Ingesting layout raw survey metadata from source (Decipher) and store on landing (ADL)
...
url_datamap = f"https://prism.decipherinc.com/api/v1/surveys/selfserve/2ca6/{survey_id}/datamap?format=json&layout={layout}"
